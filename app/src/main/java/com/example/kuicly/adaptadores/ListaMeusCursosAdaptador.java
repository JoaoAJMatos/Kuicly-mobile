...
public class ListaMeusCursosAdaptador extends BaseAdapter {
    private Context context;
    private LayoutInflater inflater;
    private ArrayList<Curso> cursos;


    public ListaMeusCursosAdaptador(Context context, ArrayList<Curso> cursos) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        //otimização
        ListaMeusCursosAdaptador.ViewHolderLista viewHolder = (ListaMeusCursosAdaptador.ViewHolderLista) view.getTag();
        if(viewHolder == null){
            viewHolder = new ListaMeusCursosAdaptador.ViewHolderLista(view);
